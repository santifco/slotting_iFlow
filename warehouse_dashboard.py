...
import limpieza_warehouse


datos_movimientos = limpieza_warehouse.main_function()[0]
datos_articulos = limpieza_warehouse.main_function()[1]
stock_articulos = limpieza_warehouse.main_function()[2]
datos = limpieza_warehouse.main_function()[3]
...
with st.sidebar:
    ...
    fecha_fin = st.date_input('Fecha final:', value=datos_movimientos['Inicio'].min())
